...
describe("CTA Component", () => {
  ...
  describe("Component Rendering", () => {
    it("should render the CTA form", () => {
      render(<CTA />);
      expect(
        screen.getByText("Empieza a cuidar tu inventario hoy."),
      ).toBeInTheDocument();
    });
    ...
    it("should have correct input placeholders", () => {
      ...
      expect(
        screen.getByPlaceholderText("Abarrotes Don Pepe"),
      ).toBeInTheDocument();
  ...
  describe("Form Validation", () => {
    ...
    it("should validate nombre field - with numbers", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/solo puede contener letras y espacios/i),
        ).toBeInTheDocument();
      });
    });
    ...
    it("should validate negocio field - too short", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/negocio debe tener al menos 2 caracteres/i),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Error Handling", () => {
    it("should display field error messages", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getAllByText(
            /debe tener al menos 2 caracteres|no puede ser vacío/i,
          )[0],
        ).toBeInTheDocument();
      });
    });
    ...
    it("should display general error message on submission failure", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Error al registrar el interés|Error desconocido/i),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("LocalStorage Integration", () => {
    ...
    it("should update localStorage after successful submission", async () => {
      ...
      await waitFor(() => {
        expect(localStorage.getItem("restock_signups")).toBeDefined();
      });
    });
  });
});
