  ...
  return (
    <div className="text-center py-6 space-y-6 animate-scale-up">
      ...
      <div className="space-y-2">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white">¡Contraseña reestablecida!</h2>
      ...
      <div className="p-4 rounded-xl bg-gray-50 dark:bg-zinc-950/40 border border-gray-100 dark:border-zinc-800 text-xs text-gray-500 dark:text-gray-450">
        Redireccionando al inicio de sesión en <span className="font-semibold text-primary text-sm inline-block w-4">{countdown}</span> segundos...
      </div>
