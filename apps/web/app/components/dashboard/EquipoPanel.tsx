...
export default function EquipoPanel({
  ...
  const [activeTab, setActiveTab] = useState<"miembros" | "invitaciones">(
    "miembros",
  );
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Administra los roles del equipo de tu negocio e invita a nuevos
          colaboradores.
        </p>
      </div>
                    ...
                    >
                      <td className="px-6 py-4 font-bold text-gray-900 dark:text-white flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-gray-450 dark:text-gray-550 font-normal">
                            ID: {member.id}
                          </p>
                        </div>
                      </td>
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center bg-white dark:bg-[#0f0f0f] border border-gray-100 dark:border-gray-900 rounded-2xl p-4 shadow-sm">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Invitaciones enviadas a futuros colaboradores. Los enlaces de
                acceso expiran en 7 días.
              </p>
            </div>
            <button
              onClick={() => setShowInviteModal(true)}
                  ...
                  {invitaciones.length > 0 ? (
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-right whitespace-nowrap">
                            <button
                              onClick={() =>
                                handleDeleteInvite(invite.id_invitacion)
                              }
                              className="text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-350 p-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/20 transition inline-block cursor-pointer"
                    ...
                    <tr>
                      ...
                      >
                        ...
                        <p className="text-xs">
                          Los colaboradores externos que invites aparecerán en
                          este apartado.
                        </p>
                      </td>
                    </tr>
