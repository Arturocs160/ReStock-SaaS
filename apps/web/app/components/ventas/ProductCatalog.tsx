    ...
    <div className="flex-1 overflow-y-auto pb-20 relative">
      ...
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm">
          Busca el producto y selecciona el lote específico del cual quieres
          descontar stock para realizar la venta.
        </p>
      </div>
              ...
              <div className="mt-auto">
                ...
                <div className="space-y-3">
                  {productLots.map((lote) => {
                    ...
                    let tagText = "Vigente";
                    if (lote.fecha_caducidad === "2023-11-15") {
                      tagColor =
                        "text-orange-700 bg-orange-50 border-orange-200";
                      tagText = "Caduca en 4d";
                    }
                    if (lote.fecha_caducidad === "2023-10-10") {
                      tagColor = "text-red-700 bg-red-50 border-red-200";
                      tagText = "Caducado hace 2d";
                    }
                    if (lote.fecha_caducidad === "2023-10-25") {
                      tagColor =
                        "text-orange-700 bg-orange-50 border-orange-200";
                      tagText = "Caduca en 11d";
                    }
                    if (lote.fecha_caducidad === "2023-11-20") {
                      tagColor =
                        "text-orange-700 bg-orange-50 border-orange-200";
                      tagText = "Caduca en 35d";
                    }
                      ...
                      >
                        <div>
                          ...
                          {lote.fecha_caducidad ? (
                            <span
                              className={`inline-block mt-0.5 text-[10px] font-semibold px-2 py-0.5 rounded-md border ${tagColor}`}
                            >
                              {tagText}
                            </span>
                          ) : (
