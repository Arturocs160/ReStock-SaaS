...
export function Features() {
  const features = [
    {
      icon: CalendarClock,
      title: "Control por lotes y caducidad",
      text: "Registra cada lote con su fecha. ReStock te avisa antes de que se vuelvan pérdida.",
    },
    {
      icon: Bell,
      title: "Alertas preventivas",
      text: "Notificaciones cuando un producto está por agotarse o por caducar.",
    },
    {
      icon: TrendingUp,
      title: "Análisis de patrones",
      text: "Detecta picos de venta y te sugiere cuándo y cuánto comprar.",
    },
    {
      icon: ShieldCheck,
      title: "Recomendaciones automáticas",
      text: "Listas de compra generadas con datos reales, no con intuición.",
    },
  ];
      ...
      <section id="problema" className="py-24 px-6 bg-white">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-2xl">
            <p className="text-xs font-bold text-[#00a365] uppercase tracking-widest">
              El problema
            </p>
            ...
            <p className="mt-5 text-base md:text-lg text-gray-600 leading-relaxed">
              Las tiendas de abarrotes, farmacias y mini-súpers pierden hasta el
              15% de su inventario por mala gestión. Revisar a ojo y a mano ya
              no alcanza.
            </p>
          </div>
            ...
            {[
              {
                ...
                text: "Lotes que vencen sin que nadie se entere hasta que ya no se pueden vender.",
                bgIcon: "bg-[#fff4ec]",
                textIcon: "text-[#f97316]",
              },
              {
                icon: Package,
                title: "Faltantes constantes",
                text: "Compras insuficientes que dejan estantes vacíos y clientes insatisfechos.",
                bgIcon: "bg-[#f0fdf4]",
              ...
              },
              {
                ...
                text: "Decisiones de compra basadas en intuición, no en patrones reales.",
                bgIcon: "bg-[#eff6ff]",
              ...
              <div
                key={p.title}
                className="p-8 rounded-2xl border border-gray-100 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.03)]"
              >
                <span
                  className={`grid place-items-center w-12 h-12 rounded-xl ${p.bgIcon} ${p.textIcon}`}
                >
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="mt-4 text-base md:text-lg text-gray-600 leading-relaxed">
              ReStock combina control por lotes, alertas inteligentes y análisis
              de ventas en una plataforma simple — pensada para negocios
              pequeños.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <ul className="mt-8 space-y-4">
              {benefits.map((b) => (
                <li
                  key={b}
                  className="flex items-start gap-3 text-sm md:text-base text-gray-700 font-medium"
                >
          ...
          <div className="grid grid-cols-2 gap-4">
            {stats.map((s) => (
              ...
              >
                <p className="text-4xl md:text-5xl font-black text-[#00a365] tracking-tight">
                  {s.n}
                </p>
                <p className="mt-2 text-xs md:text-sm font-medium text-gray-500">
                  {s.l}
                </p>
              </div>
            ))}
