                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            className={`w-full px-3.5 py-2.5 bg-gray-50 dark:bg-gray-900 border ${fieldErrors.codigo_lote ? "border-red-500 focus:ring-red-500" : "border-gray-200 dark:border-gray-800"
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            className={`w-full px-3.5 py-2.5 bg-gray-50 dark:bg-gray-900 border ${fieldErrors.cantidad_inicial ? "border-red-500 focus:ring-red-500" : "border-gray-200 dark:border-gray-800"
                                } rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:bg-white dark:text-white`}
                        />
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            className={`w-full px-3.5 py-2.5 bg-gray-50 dark:bg-gray-900 border ${fieldErrors.fecha_caducidad ? "border-red-500 focus:ring-red-500" : "border-gray-200 dark:border-gray-800"
