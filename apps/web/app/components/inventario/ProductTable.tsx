                        ...
                        {products.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan={5} className="text-center py-12 text-gray-400">
                                    ...
                                    <p className="font-semibold text-sm">No se encontraron productos registrados</p>
                                    <p className="text-xs">Intenta modificando los filtros de búsqueda o agrega un nuevo producto.</p>
                                </td>
                            </tr>
                        )}
                    </tbody>
