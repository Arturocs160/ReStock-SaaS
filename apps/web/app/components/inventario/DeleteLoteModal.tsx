...
export function DeleteLoteModal({ isOpen, onClose, loteCode, productName, onConfirm }: DeleteLoteModalProps) {
            ...
            <div className="bg-white rounded-2xl border border-gray-150 shadow-2xl w-full max-w-md overflow-hidden animate-zoom-in">
                <div className="p-6 text-center">
                    ...
                    <p className="mt-2.5 text-xs text-gray-500 leading-relaxed">
                        Estás a punto de eliminar el lote <span className="font-extrabold font-mono text-gray-800">{loteCode}</span> para el producto <span className="font-extrabold text-gray-800">{productName}</span>. Esta acción no se puede deshacer.
                    </p>
