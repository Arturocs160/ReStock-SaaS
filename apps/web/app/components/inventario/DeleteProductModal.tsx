...
export function DeleteProductModal({ isOpen, onClose, productName, onConfirm }: DeleteProductModalProps) {
            ...
            <div className="bg-white rounded-2xl border border-gray-150 shadow-2xl w-full max-w-md overflow-hidden animate-zoom-in">
                <div className="p-6 text-center">
                    ...
                    <p className="mt-2.5 text-xs text-gray-500 leading-relaxed">
                        Estás a punto de eliminar el producto <span className="font-extrabold text-gray-850">{productName}</span> y todos sus lotes asociados. Esta acción no se puede deshacer.
                    </p>
