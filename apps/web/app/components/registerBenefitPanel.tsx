  ...
  const benefits = [
    {
      ...
      description: 'Gestiona inventario con fechas de vencimiento y seguimiento preciso por lote de producto.',
    },
    {
      icon: Clock,
      title: 'Alertas preventivas',
      description: 'Recibe notificaciones automáticas antes de que tus productos caduquen o se queden sin stock.',
    },
    {
      icon: TrendingUp,
      title: 'Ventas y Métricas',
      description: 'Registra transacciones rápidamente desde el punto de venta integrado y analiza el rendimiento.',
    },
    {
      icon: ShieldCheck,
      title: 'Acceso instantáneo',
      description: 'Configura tu negocio en segundos y empieza a optimizar tu stock.',
    },
  ];
  ...
  return (
    <div className="bg-linear-to-b from-white/80 to-gray-50 dark:from-black/60 dark:to-black/40 border border-gray-100 dark:border-zinc-800 rounded-2xl p-8 shadow-sm">
      <div className="flex items-center justify-between pb-6 border-b border-gray-100 dark:border-zinc-850">
        <div>
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Todo lo que necesitas</h2>
          <p className="text-sm text-gray-500 mt-1">Lleva el control total de tu tienda o negocio.</p>
        </div>
      </div>
