    ...
    try {
      ...
      const populated: ProductoConStock[] = catalog.map((p) => {
        ...
        return {
          ...
          lotes,
          stock_actual: lotes.reduce(
            (total, lote) => total + lote.cantidad_actual,
            0,
          ),
        };
      });
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Busca el producto y selecciona el lote específico del cual
                quieres descontar stock para realizar la venta.
              </p>
            </div>
