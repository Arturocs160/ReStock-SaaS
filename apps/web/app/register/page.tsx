...
export const metadata = {
  ...
  description: 'Crea tu cuenta de ReStock para optimizar y controlar tu inventario por lotes de forma rápida y sencilla.',
};
      ...
      <main className="mx-auto w-full px-4 py-8">
        <div className="w-full max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center py-6 sm:py-12 justify-items-stretch">
          ...
          <section className="lg:col-span-7 bg-white/90 dark:bg-black/60 border border-gray-100 dark:border-zinc-800 rounded-2xl p-6 sm:p-8 shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-500">Regístrate en ReStock para comenzar a gestionar tu negocio de forma inteligente.</p>
            ...
            <div className="mt-6 text-sm text-gray-600 dark:text-gray-400">
              <p>
                ¿Ya tienes cuenta?{' '}
                <a href="/login" className="text-[#00a365] hover:underline font-medium">
                  Inicia sesión aquí
                </a>
              </p>
            </div>
