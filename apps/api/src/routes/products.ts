...
routerProducts.put("/:id_producto", requireAuth, validateDataParams(productoIdParamSchema), validateDataBody(updateProductoSchema), updateProductController);
routerProducts.delete("/:id_producto", requireAuth, validateDataParams(productoIdParamSchema), deleteProductController);
