...
import { createProductService, deleteProductService, getAllProductsServiceByTenantId, getProductByBarCodeService, getProductsByIdService, getProductsPaginationService, updateProductService, getAllCategoriesService } from "../services/productsServices";
...
export async function createProductController(req: Request, res: Response) {
    try {
        ...
        const product = await createProductService({ id_negocio, codigo_barras, nombre, precio_actual, stock_minimo_sugerido, id_categoria });
...
export async function updateProductController(req: Request, res: Response) {
    try {
        ...
        const product = await updateProductService({ id_producto, id_negocio, codigo_barras, nombre, precio_actual, stock_minimo_sugerido, id_categoria });
        res.status(200).json(product);
    } catch (error: any) {
